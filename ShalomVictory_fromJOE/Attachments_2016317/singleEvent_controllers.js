...
myApp.factory("bookService", function() {
    var books = [
       {
           imgUrl: "victoryToronto2016_logo.jpg",
           name: "Victory Toronto - 2016",
           binding: "Sep-23-2016 @ 9:00 AM to Sep-25-2016 @ 4:00 PM",

           price: 205,
           rating: 4,

           publisher: "The Trinity Hall, Canadian Coptic Centre",
           releaseDate: "1245 Eglinton Ave West, Toronto, ON ­ M1B 2V4, Canada",
...
myApp.controller("EventHeadController", function($scope, $location) {
    $scope.appDetails = {};
	$scope.appDetails.title = "Victory Toronto - 2016";
	$scope.appDetails.tagline = "We've collection of 1 Million Books!";
